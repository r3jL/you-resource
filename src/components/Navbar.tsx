        ...
        <div className="flex items-center justify-between" style={{ height: '60px' }}>
          <div className="flex items-center gap-6">
            <Link href="/" className="flex items-center gap-2.5">
              ...
              <span className="text-lg font-bold" style={{ fontFamily: 'Syne, sans-serif', color: 'var(--color-heading)' }}>
          ...
          <div className="flex items-center gap-3">
            ...
            {isSignedIn ? (
              <div className="flex items-center gap-2">
                <span className="hidden sm:block text-sm font-medium" style={{ color: 'var(--color-muted)' }}>{displayName}</span>
                <UserButton
                  appearance={{
                    elements: {
              ...
              <div className="flex items-center gap-2">
                <SignInButton mode="redirect">
                  <button className="text-sm font-medium transition-colors duration-150 px-3 py-1.5" style={{ color: 'var(--color-muted)' }}>
                    Sign in
                  </button>
                </SignInButton>
